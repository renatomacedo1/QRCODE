...
public class HuffmanCode {
	 ...
	 */
	public static int[] charsetReturner(String string) { //Devolve o charset para criar a tree
		// Texto exemplo para Compactar e Decodificação usando o Algoritmo de Huffman
        String test = string; // Tamanho do texto = 112 bits
		//String test = "Esta é a String de teste para a codifucação do algoritmo de Huffman. Estou a escrever tanto para verificar se efetivamente funciona corretamente.";
        ...
        String treeString = (Arrays.toString(charFreqs));//Transforma o charFreqs em String para ser enviada no QR Code*/

        return charFreqs;//Devolve o array de inteiros para criar a tree

    }

    //Recebe a
    public static String encodedReturner(String string, int[] charset1) {
        // Texto exemplo para Compactar e Decodificação usando o Algoritmo de Huffman
        String test = string; // Tamanho do texto = 112 bits
        //String test = "Esta é a String de teste para a codifucação do algoritmo de Huffman. Estou a escrever tanto para verificar se efetivamente funciona corretamente.";
        // Neste exemplo será considerado que teremos no máximo 256 caracteres diferentes
        ...
        return encode;//Retorna a string codificada
        // Decodificar o texto
       /* System.out.println("\n\nTEXTO DECODIFICADO");
        System.out.println(decode(tree,encode));*/
    }

    public static String decodedReturner(String string, int[] charset1) {
        // Texto exemplo para Compactar e Decodificação usando o Algoritmo de Huffman
        String test = string; // Tamanho do texto = 112 bits
        //String test = "Esta é a String de teste para a codifucação do algoritmo de Huffman. Estou a escrever tanto para verificar se efetivamente funciona corretamente.";
        // Neste exemplo será considerado que teremos no máximo 256 caracteres diferentes
        ...
        // Decodificar o texto
        String decode = decode(tree,test);

        return decode;//Retorna a string codificada
    }
